...
const HeaderConfigSchema = new mongoose.Schema(
  {
    ...
    backgroundColor: {
      ...
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une couleur hexadécimale valide!`,
      },
    },
    color: {
      type: String,
    ...
    fontSize: {
      ...
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une taille de police valide!`,
      },
    },
    fontWeight: {
      type: String,
  ...
  style: {
    ...
    top: {
      ...
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une valeur de position \'top\' valide!`,
      },
    },
    left: {
      type: String,
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une valeur de position \'left\' valide!`,
      },
    },
    right: {
      type: String,
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une valeur de position \'right\' valide!`,
      },
    },
    bottom: {
      type: String,
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une valeur de position \'bottom\' valide!`,
      },
    },
    border: {
      type: String,
      validate: {
        validator: function (v) {
          return (
            !v ||
            /^(\d+px\s*(solid|dashed|dotted)\s*#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3}))$/.test(
              v
            )
          );
        },
    ...
    borderColor: {
      ...
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pasBROKEN LINK n'est pas une couleur de bordure valide!`,
      },
    },
    borderWidth: {
      type: String,
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas une épaisseur de bordure valide!`,
      },
    },
    borderRadius: {
      type: String,
      validate: {
        ...
        message: (props) =>
          `${props.value} n'est pas un rayon de bordure valide!`,
      },
    },
    boxShadow: String,
    display: String,
